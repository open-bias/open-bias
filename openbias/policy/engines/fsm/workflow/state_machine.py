...
from openbias.policy.engines.fsm.workflow.schema import State, Transition, WorkflowDefinition
...
class WorkflowStateMachine:
    ...
    Example:
        ```python
        from openbias.policy.engines.fsm.workflow import WorkflowParser, WorkflowStateMachine
